...
# 1. INITIALIZE TELEBOT & FLASK FIRST (PEHLE INITIALIZE HAR HALAT ME)
...
def start_cmd(message):
    ...
    welcome_text = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━\n"
        "Good day, Sir! Powered by Gemini AI, fully online.\n\n"
...
def handle_ai_chat(message):
    ...
    if ai_client:
        try:
            ...
            # Using valid model name gemini-1.5-flash
...
def callback_handler(call):
    if call.data == "sys_info":
        ...
        jarvis.answer_callback_query(call.id, "J.A.R.V.I.S. Engine is fully operational!", show_alert=True)
